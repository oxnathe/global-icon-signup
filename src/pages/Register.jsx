  ...
  return (
    <main>
          ...
          <div className="grid min-h-[650px] items-center gap-16 py-16 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                <a
                  href="#register-form"
                  className="group flex items-center gap-3 rounded-xl bg-[#F29925] px-6 py-4 text-sm font-bold text-white transition hover:bg-[#df8213]"
                >
                  Start your journey
                  <ArrowRight
                    size={17}
      ...
      <section className="bg-black px-5 py-12 text-white">
        ...
        <div className="mx-auto mt-10 max-w-7xl border-t border-white/10 pt-6 text-[10px] text-white/25">
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        <CheckCircle2
          size={20}
          className={featured ? "text-white" : "text-[#F29925]"}
        />
      </div>
